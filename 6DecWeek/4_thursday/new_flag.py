...
ireland-flag = image-url("https://code.pyret.org/shared-image-contents?sharedImageId=1nrB03ySkGdcLbMFkRYnJdkZX9ZZzOcYT")

mauritius-flag = image-url("https://code.pyret.org/shared-image-contents?sharedImageId=1sngY8N0zWdMkrYm1rCet6OLl8YVgCHvh")
...
# Answer questions (1-2) about the netherlands code below. the type 'netherlands' in the interactions area to make sure it works.
background-netherlands = rectangle(300, 200, "outline", "black")
...
netherlands =
  put-image(blue-stripe, 150, 200 / 6,
    put-image(red-stripe, 150, 5 * (200 / 6),
...
# NOTEBOOK: In what ways is the Irish flag similar to the flag of the Netherlands?
# NOTEBOOK: In what ways is the Irish flag different from the flag of the Netherlands?

##################################################

#Code for the flag of Ireland

# Answer questions (3-5) in your worksheet. then define your code in the space below.

# Define the shapes needed to make the Irish flag, starting with a 300 x 200 background, and type them into the Interactions Area to see what they produce.


# Define a variable "ireland" to build the image of the Irish flag, identifying what coordinates will correctly locate the center of each piece.
...
# NOTEBOOK:Is this flag more like the flag of Ireland or flag of the Netherlands?
# NOTEBOOK:In what ways is this flag the same as that flag?
# NOTEBOOK: In what ways is this flag different from that flag?
